            ...
            <main>
                <article>
                    ...
                    <div className="introducao">
                        <img src="assets/img/ns-fatima.jpg"></img>
                    ...
                    <div className="aparicoes">
                        ...
                        <p className="subtitulo">Aparições de Fátima</p>

                        <div className="img-content">
                            <img src="assets/img/anjo.jpg"></img>
                        </div>
                    ...
                    <div className="aparicoes">
                        ...
                        <p className="subtitulo">13 de Maio de 1917</p>

                        <div className="img-content">
                            <img src="assets/img/pastorinhos.jpg"></img>
                        </div>
                    ...
                    <div className="aparicoes">
                        ...
                        <p className="subtitulo">13 de Junho de 1917</p>

                        <div className="img-content">
                            <img src="assets/img/local-aparicao.jpg"></img>
                        </div>
                    ...
                    <div className="aparicoes">
                        ...
                        <p className="subtitulo">13 de Julho de 1917</p>

                        <div className="img-content">
                            <img src="assets/img/pastorinhos2.jpg"></img>
                        </div>
                    ...
                    <div className="aparicoes">
                        ...
                        <p className="subtitulo">13 de Agosto de 1917</p>

                        <div className="img-content">
                            <img src="assets/img/pastorinhos3.jpg"></img>
                        </div>
                    ...
                    <div className="aparicoes">
                        ...
                        <p className="subtitulo">13 de Setembro de 1917</p>

                        <div className="img-content">
                            <img src="assets/img/povo.jpg"></img>
                        </div>
                    ...
                    <div className="aparicoes">
                        ...
                        <p className="subtitulo">13 de Outubro de 1917</p>

                        <div className="img-content">
                            <img src="assets/img/milagre-do-sol.jpg"></img>
                        </div>
